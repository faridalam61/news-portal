...
const createNewsCard = (data)=>{
    ...
    data.forEach(news =>{
        console.log(news);
        container.innerHTML += `
            <div class="flex flex-col lg:flex-row gap-6 rounded border border-slate-800 dark:border-slate-500 bg-white dark:bg-slate-600 mb-6">
                <div class="w-full lg:w-1/4">
                    <img src="${news.image_url}" alt="" class="rounded w-full">
                </div>
